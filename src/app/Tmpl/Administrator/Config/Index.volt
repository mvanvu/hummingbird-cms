<form id="admin-edit-form" method="post" action="{{ uri.routeTo('save') }}">
    <div class="config-container uk-form-horizontal">
        <div uk-grid>
            ...
            <div class="uk-width-3-4@m uk-width-4-5@l">
                <ul id="config-id" class="uk-switcher">
                    <li class="config-site uk-active">
                        {{ formsManager.renderFormFields('site') }}
                    </li>
                    <li class="config-locale">
                        {{ formsManager.renderFormFields('locale') }}
                    </li>
                    <li class="config-users">
                        {{ formsManager.renderFormFields('user') }}
                    </li>
                    <li class="config-system">
                        {{ formsManager.renderFormFields('system') }}
                        <div class="uk-margin">
