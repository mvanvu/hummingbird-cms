...
INSERT INTO `#__plugins` VALUES (1, 'System', 'Cms', '1.0', 'Y', 'Y', '2021-02-03 20:40:07', 3, null, 0, '2021-02-03 15:06:56', 3, '{}', '{"name": "System", "group": "Cms", "title": "cms-plugin-title", "author": "Mai Vu", "version": "1.0.0", "authorUrl": "https://github.com/mvanvu", "updateUrl": null, "authorEmail": "mvanvu@gmail.com", "description": "cms-plugin-desc"}', 1);
...
CREATE TABLE `#__queue_jobs` (
  ...
  `handling` enum('Y','N') NOT NULL DEFAULT 'N',
  `createdBy` int(10) unsigned NOT NULL DEFAULT '0',
  `createdAt` datetime NOT NULL,
...
INSERT INTO `#__roles` VALUES (1,'Super user','S','Master super user','{}','Y','2020-12-23 02:33:28',3,'2021-01-18 09:52:59',3,NULL,0),(2, 'Manager', 'M', 'Can manage the site but can&#39;t config', '{"tag": {"edit": "Y", "admin": "N", "create": "Y", "delete": "N", "manage": "Y", "editState": "N", "manageOwn": "Y"}, "post": {"edit": "Y", "admin": "N", "create": "N", "delete": "Y", "manage": "Y", "editState": "N", "manageOwn": "N", "manageField": "Y", "manageComment": "Y", "manageCategory": "Y"}, "user": {"edit": "Y", "admin": "N", "create": "Y", "delete": "N", "manage": "Y", "activate": "N", "manageOwn": "Y"}, "media": {"admin": "N", "delete": "N", "manage": "Y", "upload": "Y", "manageOwn": "Y"}, "cms-post": {"edit": "N", "admin": "N", "create": "N", "delete": "N", "manage": "N", "editState": "N", "manageOwn": "N", "manageField": "N", "manageComment": "N", "manageCategory": "N"}, "post-category": {"edit": "N", "admin": "N", "create": "N", "delete": "N", "manage": "Y", "editState": "Y", "manageOwn": "Y"}}', 'Y', '2021-02-07 11:14:45', 1, '2021-02-07 11:16:22', 1, null, 0),(3,'Registered','R','Default user register','{}','Y','2020-12-23 02:40:19',3,'2021-02-04 03:19:26',3,NULL,0);
...
INSERT INTO `#__templates` VALUES (1,'Sparrow - default template','2021-01-09 09:44:23',3,NULL,0,'2021-02-06 10:12:49',3,'Y','{\"positions\":\"Aside\\r\\nFooter\"}');
...
INSERT INTO `#__users` VALUES (1, 'Super user', 'admin@email.com', 'admin', '$2y$10$YVlSQUJybE9pdEJsZFVpb.VOQNhXLbZiVYUprV6JlsuIoMdpjxwle', 1, 'Y', '2019-09-21 07:18:35', '2019-11-15 10:35:33', 0, '2021-02-04 07:09:49', 3, null, 0, '738f9424-f296-407a-87b7-780c1200b02a', '{"avatar":null,"timezone":"UTC"}', '');
